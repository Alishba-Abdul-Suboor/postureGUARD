...
interface SpineExercise3ScreenProps {
  navigation: any;
}

const SpineExercise3Screen: React.FC<SpineExercise3ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Cross Touch and Reach</Text>
      <MoveNextButton targetScreen="SpineExerciseScreen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/cross touch 2.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Stand with your feet shoulder-width apart.</Text> 
        <Text style={styles.sitOrStand}>Extend your arms straight out to the sides.</Text>
        <Text style={styles.sitOrStand}>Cross your right arm over your left, bringing your palms together.</Text>
        <Text style={styles.sitOrStand}>Inhale as you reach up with your crossed arms, extending your spine.</Text>
        <Text style={styles.sitOrStand}>Exhale as you bend to one side, feeling a stretch along the side of your torso.</Text>
        <Text style={styles.sitOrStand}>Inhale and return to the center, then repeat on the other side.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Enhances flexibility in the torso and shoulders. It also engages the obliques, promoting core strength and stability. Regular practice can contribute to improved overall body flexibility.</Text>
      </View>
      </View>
    </View>
  );
...
export default SpineExercise3Screen;
