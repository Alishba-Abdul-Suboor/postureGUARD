...
interface ShoulderExercise3ScreenProps {
  navigation: any;
}

const ShoulderExercise3Screen: React.FC<ShoulderExercise3ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Torso Twist</Text>
      <MoveNextButton targetScreen="ShoulderExerciseScreen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/torso twist 2.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Sit or stand with an upright posture.</Text> 
        <Text style={styles.sitOrStand}>Place your hands on your hips or clasp them in front of you.</Text>
        <Text style={styles.sitOrStand}>Inhale and lengthen your spine.</Text>
        <Text style={styles.sitOrStand}>Exhale as you twist your torso to one side, looking over your shoulder.</Text>
        <Text style={styles.sitOrStand}>Hold for a few seconds, then return to the center and repeat on the other side.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Enhance spinal flexibility and help relieve tension in the back. This exercise is beneficial for improving overall mobility and reducing stiffness in the spine.</Text>
      </View>
      </View>
    </View>
  );
...
export default ShoulderExercise3Screen;
