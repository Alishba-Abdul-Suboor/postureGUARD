...
interface NeckExercise2ScreenProps {
  navigation: any;
}

const NeckExercise2Screen: React.FC<NeckExercise2ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Side To Side Turns</Text>
      <MoveNextButton targetScreen="NeckExercise3Screen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/side-to-side.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Keep your head level and slowly turn it to one side.</Text> 
        <Text style={styles.sitOrStand}>Hold for a moment, then turn to the other side.</Text>
        <Text style={styles.sitOrStand}>Repeat for 10-15 reps on each side.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Improves neck mobility, reduces stiffness, and helps prevent muscle imbalances.</Text>
      </View>
      </View>
    </View>
  );
...
export default NeckExercise2Screen;
