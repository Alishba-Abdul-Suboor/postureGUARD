...
interface SpineExerciseScreenProps {
  navigation: StackNavigationProp<ParamListBase>;
}

const SpineExerciseScreen: React.FC<SpineExerciseScreenProps> = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <LinearGradient
       ...
       <View style={styles.topHeader}>
        <GoBackButton />
        <Text style={styles.header}>Spine Exercises</Text>
        </View>
        <Image
          style={styles.neck1Icon}
          source={require("./assets/images/spineVector.png")}
        />
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("SpineExercise1Screen")}
      >
      <LinearGradient
        ...
        >
          <Image
            ...
            source={require("./assets/images/seated-side-bend.png")}
          />
          <Text style={styles.cardTitle}>Seated Side Bend</Text>
          <Image
      ...
      <Pressable
        // style={[styles.moveback, styles.movebackPosition]}
        onPress={() => navigation.navigate("SpineExercise2Screen")}
      >
       <LinearGradient
          colors={["#ADD9D8", "#3DD9D6"]}
          style={styles.card}
      ...
      <Image
        style={styles.neckIcons}
        source={require("./assets/images/side-twist.png")}
      />
        <Text style={styles.cardTitle}>Seated Side Twist </Text>
        <Image
        style={styles.doubleLeftIcon}
        source={require("./assets/images/double-left.png")}
      />
      ...
      <Pressable
        // style={[styles.moveback, styles.movebackPosition]}
        onPress={() => navigation.navigate("SpineExercise3Screen")}
      >
       <LinearGradient
          colors={["#ADD9D8", "#3DD9D6"]}
          style={styles.card}
      ...
      <Image
        style={styles.neckIcons}
        source={require("./assets/images/cross-touch.png")}
      />
        <Text style={styles.cardTitle}>Cross Touch and Reach</Text>
        <Image
        style={styles.doubleLeftIcon}
        source={require("./assets/images/double-left.png")}
      />
...
export default SpineExerciseScreen;
