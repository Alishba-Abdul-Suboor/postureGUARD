...
interface NeckExercise3ScreenProps {
  navigation: any;
}

const NeckExercise3Screen: React.FC<NeckExercise3ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Side To Side Tilts</Text>
      <MoveNextButton targetScreen="NeckExerciseScreen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/side-to-side-tilts.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Maintain good posture while sitting or standing.</Text> 
        <Text style={styles.sitOrStand}>Tilt your head to one side, bringing your ear towards your shoulder.</Text>
        <Text style={styles.sitOrStand}>Repeat on the other side, alternating for 10-15 reps on each side.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Relieves tension, enhances flexibility, and promotes better range of motion in the neck.</Text>
      </View>
      </View>
    </View>
  );
...
export default NeckExercise3Screen;
