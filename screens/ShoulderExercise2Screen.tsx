...
interface ShoulderExercise2ScreenProps {
  navigation: any;
}

const ShoulderExercise2Screen: React.FC<ShoulderExercise2ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Shoulder Rolls</Text>
      <MoveNextButton targetScreen="ShoulderExercise3Screen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/shoulder roll 2.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Stand or sit comfortably.</Text> 
        <Text style={styles.sitOrStand}>Shrug your shoulders up towards your ears.</Text>
        <Text style={styles.sitOrStand}>Roll your shoulders back in a circular motion, completing 10-15 rotations.</Text>
        <Text style={styles.sitOrStand}>Reverse the direction and roll forward for 10-15 repetitions</Text>

        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Effective for releasing tension in the shoulders and upper back. This exercise promotes better circulation and can alleviate stiffness.</Text>
      </View>
      </View>
    </View>
  );
...
export default ShoulderExercise2Screen;
