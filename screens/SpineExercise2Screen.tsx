...
interface SpineExercise2ScreenProps {
  navigation: any;
}

const SpineExercise2Screen: React.FC<SpineExercise2ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Seated Side Twist</Text>
      <MoveNextButton targetScreen="SpineExercise3Screen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/side twist 2.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Cross one leg over the other, placing the foot flat on the floor.</Text>
        <Text style={styles.sitOrStand}>Place your opposite elbow on the outside of your crossed knee, with your hand reaching behind you for support.</Text>
        <Text style={styles.sitOrStand}>Inhale, lengthening your spine, and exhale as you gently twist towards the crossed knee.</Text>
        <Text style={styles.sitOrStand}>Hold the stretch for 15-30 seconds, feeling the rotation in your spine.</Text>
        <Text style={styles.sitOrStand}>Inhale and return to the center, then repeat on the other side.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Promotes spinal mobility and stretches the muscles along the back and sides. It also engages the core muscles, contributing to improved flexibility and posture.</Text>
      </View>
      </View>
    </View>
  );
...
export default SpineExercise2Screen;
