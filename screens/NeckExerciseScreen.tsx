...
interface NeckExerciseScreenProps {
  navigation: StackNavigationProp<ParamListBase>;
}

const NeckExerciseScreen: React.FC<NeckExerciseScreenProps> = ({ navigation }) => {
    ...
    <View style={styles.container}>
      ...
      <LinearGradient
       ...
       <View style={styles.topHeader}>
        <GoBackButton />
        <Text style={styles.header}>Neck Exercises</Text>
        </View>
        <Image
      ...
      <Pressable
        ...
        onPress={() => navigation.navigate("NeckExercise1Screen")}
      >
      <LinearGradient
        ...
        >
          <Image
            ...
            source={require("./assets/images/back-and-forward-1.png")}
          />
          <Text style={styles.cardTitle}>Up and Down Nods</Text>
          <Image
      ...
      <Pressable
        // style={[styles.moveback, styles.movebackPosition]}
        onPress={() => navigation.navigate("NeckExercise2Screen")}
      >
       <LinearGradient
          colors={["#ADD9D8", "#3DD9D6"]}
          style={styles.card}
      ...
      <Image
        style={styles.neckIcons}
        source={require("./assets/images/neck-turn-1.png")}
      />
        <Text style={styles.cardTitle}>Side To Side Turns</Text>
        <Image
        style={styles.doubleLeftIcon}
        source={require("./assets/images/double-left.png")}
      />
      ...
      <Pressable
        // style={[styles.moveback, styles.movebackPosition]}
        onPress={() => navigation.navigate("NeckExercise3Screen")}
      >
       <LinearGradient
          colors={["#ADD9D8", "#3DD9D6"]}
          style={styles.card}
      ...
      <Image
        style={styles.neckIcons}
        source={require("./assets/images/side-bend-1.png")}
      />
        <Text style={styles.cardTitle}>Side To Side Tilts</Text>
        <Image
        style={styles.doubleLeftIcon}
        source={require("./assets/images/double-left.png")}
      />
...
export default NeckExerciseScreen;
