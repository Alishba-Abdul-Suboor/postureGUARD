...
interface NeckExercise1ScreenProps {
  navigation: any;
}

const NeckExercise1Screen: React.FC<NeckExercise1ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Up and Down Nods</Text>
      <MoveNextButton targetScreen="NeckExercise2Screen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/up-down.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Sit or stand with a straight posture.</Text> 
        <Text style={styles.sitOrStand}>Slowly nod your head up and down, keeping the movement controlled and gentle.</Text>
        <Text style={styles.sitOrStand}>Repeat for 10-15 repetitions.</Text>
        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsAlleviatesStrain}>Alleviates strain, enhances posture, and promotes a balanced range of motion in the neck.</Text>
      </View>
      </View>
    </View>
  );
...
export default NeckExercise1Screen;
