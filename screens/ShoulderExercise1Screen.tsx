...
interface ShoulderExercise1ScreenProps {
  navigation: any;
}

const ShoulderExercise1Screen: React.FC<ShoulderExercise1ScreenProps> = () => {
...
const getArcPath = (index: number) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <GoBackButton/>
      <Text style={styles.header} >Shoulder Rotation </Text>
      <MoveNextButton targetScreen="ShoulderExercise2Screen"/>
      </View>
      <View style={styles.centerCard}>
      <Image
        style={styles.maskGroupIcon}
    
        source={require("./assets/images/sh rotation 2.png")}
      />
      ...
      <View style={styles.rounds}>
        ...
        <Text style={styles.sitOrStand}>Stand or sit with a straight posture.</Text> 
        <Text style={styles.sitOrStand}>Lift your shoulders up towards your ears.</Text>
        <Text style={styles.sitOrStand}>Rotate your shoulders in a circular motion, moving them backward for 10-15 repetitions.</Text>
        <Text style={styles.sitOrStand}>Reverse the direction and rotate forward for 10-15 repetitions.</Text>

        
      <Text style={styles.commentsHeader}>Comments:</Text>
      <Text style={styles.commentsText}>Improve flexibility and reduce tension in the shoulder joints. This exercise is beneficial for maintaining shoulder mobility and preventing stiffness.</Text>
      </View>
      </View>
    </View>
  );
...
export default ShoulderExercise1Screen;
